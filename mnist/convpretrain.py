...
def pretrain_mnist(x_train, model_path):
    def batch_gen(X):
        ...
        while True:
            ...
            for i in indices:
                yield np.asarray(X[i]).reshape(28, 28, 1)
    ...
    model = CRBM(batch_gen(x_train), numbatches, (28, 28, 1), (3, 3), 1000, params, create_outputter('mnist/data/rbm1_output.hdf5', 100, 1000), callbacks=[mnist_callback])
